        ...
        <div class="collapse navbar-collapse" id="navMain">
          ...
          <div class="d-flex gap-2 align-items-center flex-wrap" id="nav-auth-buttons">
            <a href="{{ route('login') }}" class="btn btn-outline-light px-4 rounded-pill" id="nav-btn-login">تسجيل
              الدخول</a>
            <a href="{{ route('register') }}" class="btn btn-secondary px-4 rounded-pill fw-bold" id="nav-btn-register">ابدأ
              الكفالة الآن</a>
          </div>
        </div>
      </div>
  ...
  <main>
      ...
      <div class="container">
        <div class="row align-items-center g-4">
          <div class="col-md-7">
            ...
            <h1 class="fw-black text-white display-5 mb-3" style="font-family: 'Cairo', sans-serif;">نسعد دائماً
              بالإجابة
              على استفساراتكم الشريفة</h1>
            <p class="lead text-white-50 mb-0">نحن هنا لمساعدتكم في كل ما يتعلق بكفالة الأيتام وتوفير الرعاية الكريمة
        ...
        <div class="row g-4">
              ...
              <div class="card contact-info-card p-4 shadow-sm border">
                <div class="d-flex align-items-start gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-muted small mb-0">شمال قطاع غزة، جباليا البلد / فرع الطوارئ الإداري المساعد بدير
                      البلح،
              ...
              <div class="card contact-info-card p-4 shadow-sm border">
                <div class="d-flex align-items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="tel:+970591234567" class="text-dark fw-bold text-decoration-none small" dir="ltr">+970
                      59-123-4567</a>
                    <p class="text-muted small mt-2 mb-1">شؤون الأوصياء ومطالبات العائلات بغزة:</p>
                    <a href="tel:+970597654321" class="text-dark fw-bold text-decoration-none small" dir="ltr">+970
                      59-765-4321</a>
                  </div>
                </div>
              </div>
              ...
              <div
                ...
                <div class="d-flex gap-3">
                  ...
                  <div>
                    ...
                    <p class="small mb-0 text-muted">يعمل فريق المجهزين والباحثين الميدانيين طيلة أيام الأسبوع لمجابهة
                      الحالات الصعبة، ويتم الرد الإداري من السبت إلى الخميس: 9:00 صباحاً - 4:00 مساءً بتوقيت القدس
                      المعتمد.</p>
                  </div>
                </div>
              </div>
          ...
          <div class="col-lg-8">
            <div class="card card-contact-form p-4 p-md-5 shadow-sm border">
              <h4 class="fw-bold text-dark mb-2"><i class="bi bi-chat-right-text-fill text-primary-green me-2"></i>
                إرسال
                رسالة واستفسار جديد</h4>
              <p class="text-muted text-small mb-4">يرجى تعبئة الحقول المطلوبة بدقة وتوجيه رسالتك للقسم المعني ليتم
                إحالة
              ...
              <form action="{{ route('contact.send') }}" method="POST" id="kanaf-contact-form">
                ...
                <div class="row g-3">
                  ...
                  <div class="col-md-6 text-start">
                    <label for="contact-name" class="form-label text-small fw-semibold text-muted">اسمك بالكامل <span
                        class="text-danger">*</span></label>
                    <input type="text" name="name" class="form-control" id="contact-name" placeholder="مثال: عبد الرحمن الباتع"
                      required>
                  ...
                  <!-- Email -->
                  <div class="col-md-6 text-start">
                    <label for="contact-email" class="form-label text-small fw-semibold text-muted">البريد الإلكتروني
                      <span class="text-danger">*</span></label>
                    <input type="email" name="email" class="form-control" id="contact-email" placeholder="name@example.com" required>
                    <div class="invalid-feedback">يرجى إدخال بريد إلكتروني صالح لنتمكن من الرد عليك.</div>
                  </div>

                  <!-- Phone number -->
                  <div class="col-md-6 text-start">
                    <label for="contact-phone" class="form-label text-small fw-semibold text-muted">رقم الجوال /
                      الواتساب
                      <span class="text-caption text-muted">(اختياري)</span></label>
                    <input type="tel" name="phone" class="form-control text-start" id="contact-phone" placeholder="059XXXXXXX"
                      dir="ltr">
                  </div>

                  <!-- Query Type -->
                  <div class="col-md-6 text-start">
                    <label for="contact-type" class="form-label text-small fw-semibold text-muted">قسم الاستفسار الرئيسي
                      <span class="text-danger">*</span></label>
                    <select name="type" class="form-select text-small" id="contact-type" required>
                      <option value="" disabled selected>اختر القسم المناسب للرسالة...</option>
                      <option value="sponsorship_inquiry">استفسار حول كفالة يتيم جديد (أفراد ومؤسسات)</option>
                      <option value="guardian_support">حقوق ومطالبات أوصياء الأيتام (عائلات غزة)</option>
                      <option value="partnership_request">شراكة وتعاون مؤسسي أو دعم عيني طارئ</option>
                      <option value="technical_issue">مشكلة تقنية داخل لوحة التحكم أو الحساب</option>
                  ...
                  <div class="col-md-12 text-start">
                    <label for="contact-subject" class="form-label text-small fw-semibold text-muted">موضوع الاستفسار
                      <span class="text-danger">*</span></label>
                  ...
                  <!-- Message Box -->
                  <div class="col-md-12 text-start">
                    <label for="contact-message" class="form-label text-small fw-semibold text-muted">تفاصيل الرسالة
                  ...
                  <div class="col-12 mt-4 text-center text-md-start">
                    <button type="submit" class="btn btn-submit-contact px-5 fs-6 w-100 w-md-auto">
    ...
    <section class="py-4 bg-light">
      <div class="container text-center">
        <h5 class="fw-bold mb-3 text-dark"><i class="bi bi-shield-fill-check text-primary-green me-1"></i> ضمان ومنهجية
          تتبع كنف الموثوقة</h5>
        <p class="max-w-xl mx-auto small text-muted mb-0">جميع البيانات والرسائل الواردة إلينا عبر هذا النموذج مشفرة
          ومصنفة بالكامل بأعلى مستوى من النزاهة القانونية وحقوق وحماية الطفل. ستتلقى إشعاراً مرجعياً مباشراً بالاستجابة
