...
<body>
  ...
  <main>
        ...
        <div class="row align-items-center g-5">
          <div class="col-lg-7 text-white text-end">
            <span
              ...
              data-aos="fade-down" data-aos-delay="200"><i class="bi bi-star-fill me-1"></i> كنف الإنسانية: رعاية لا
              تنقطع</span>
            <h1 class="fluid-hero-title mb-4 lh-base text-white" id="hero-text-reveal">
              كُنْ مَعَ <span class="text-secondary-gold">اليَتِيمِ</span> كَنَفَاً،<br>تنعم بالسكينَةِ والبركَة
            </h1>
            <p class="lead text-white-50 mb-5 fs-5 style-arabic-poetry"
              style="max-width: 630px; line-height: 1.9; text-align: right;" data-aos="fade-up" data-aos-delay="600">
              أنت لا كافل ليتيم فحسب، بل رفيقُ مجرى حياة بأكمله، تنعم بشفافية مفرطة، وبتقارير تفاعلية، واتصال روحي
              وإنساني
          ...
          <div class="col-lg-5 position-relative text-center d-none d-lg-block">
            ...
            <div class="hero-floating-stat floating-element-reverse" style="bottom: -20px; left: -10px; width: 280px;">
              ...
              <div>
                <h6 class="fw-bold mb-1 text-dark" style="font-size: 0.95rem;">التمكين التعليمي الأرقى</h6>
        ...
        <div class="row g-4 justify-content-center">
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
            <div
              ...
              <div class="position-absolute top-0 start-0 w-100 h-100 bg-warm opacity-25" style="z-index: 1;"></div>
              <div class="position-relative" style="z-index: 2;">
                <div class="text-secondary-gold mb-2"><i class="bi bi-people-fill fs-1"></i></div>
                <h2 class="display-3 fw-black text-primary-green mb-1 count-number" data-target="1643">0</h2>
          ...
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
            <div
              ...
              <div class="position-relative" style="z-index: 2;">
                ...
                <h2 class="display-3 fw-black text-primary-green mb-1 count-number" data-target="10">0</h2>
          ...
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
            <div
              ...
              <div class="position-absolute top-0 start-0 w-100 h-100 bg-warm opacity-25" style="z-index: 1;"></div>
              <div class="position-relative" style="z-index: 2;">
                <div class="text-secondary-gold mb-2"><i class="bi bi-shield-fill-check fs-1"></i></div>
                <h2 class="display-3 fw-black text-primary-green mb-1 count-number" data-target="80">0</h2>
                <!-- <span class="fs-1 fw-bold text-primary-green">%</span> -->
      ...
      <div class="container py-4">
        <div class="text-center mb-5" data-aos="fade-up">
          ...
          <p class="text-muted fs-5 mx-auto" style="max-width: 650px;">
            بلمسة واحدة يمكنك أن تكون منبع الأمل لقلب صغير. اختر من القائمة أدناه لتبدأ رحلة أثر تفاعلية مسجلة يومياً.
          </p>
        </div>
            ...
            <div class="kanaf-card h-100 bg-white">
              ...
              <div class="card-body p-4">
                ...
                <div class="d-flex flex-wrap gap-1 mb-3">
                  ...
                  <span class="badge bg-info-subtle text-dark border border-info-subtle rounded-pill">
                    أشد حاجة
                  </span>
                </div>

                <div class="d-flex gap-3 text-muted mb-3" style="font-size:.85rem;font-weight:600;">
                  <span>
                ...
                <p class="text-muted small lh-base mb-4">
                  فقد أحمد والده ووالدته خلال الحرب ويعيش حالياً مع جدته.
                  يحلم بإكمال تعليمه ليصبح مهندساً ويساعد أسرته في المستقبل.
                </p>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="kanaf-card h-100 bg-white">
              ...
              <div class="card-body p-4">
                ...
                <div class="d-flex flex-wrap gap-1 mb-3">
                  <span class="badge bg-warning-subtle text-dark rounded-pill">
                    ناجية وحيدة
                  </span>
                </div>

                <div class="d-flex gap-3 text-muted mb-3" style="font-size:.85rem;font-weight:600;">
                  <span>العمر: 8 سنوات</span>
                  <span>الجنس: أنثى</span>
                </div>

                <p class="text-muted small lh-base mb-4">
                  تعيش سارة مع خالتها بعد فقدان والديها وتحتاج إلى دعم
                  مستمر لتأمين التعليم والرعاية الصحية.
                </p>

                <div class="border-top pt-3 d-flex justify-content-between align-items-center">
                  <div>
                    <span class="text-muted d-block mb-1">مبلغ الكفالة</span>
                    <span class="fs-4 fw-black text-primary-green">$45</span>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="kanaf-card h-100 bg-white">
              ...
              <div class="card-body p-4">
                ...
                <div class="d-flex gap-3 text-muted mb-3" style="font-size:.85rem;font-weight:600;">
                  <span>العمر: 12 سنة</span>
                  <span>الجنس: ذكر</span>
                </div>

                <p class="text-muted small lh-base mb-4">
                  يعاني محمد من الربو ويحتاج إلى رعاية صحية مستمرة
                  ويطمح لدراسة الطب ومساعدة الأطفال المرضى.
                </p>

                <div class="border-top pt-3 d-flex justify-content-between align-items-center">
                  <div>
                    <span class="text-muted d-block mb-1">مبلغ الكفالة</span>
                    <span class="fs-4 fw-black text-primary-green">$60</span>
                    <span class="text-muted">/ شهرياً</span>
                  </div>
    ...
    <section id="how-it-works" class="py-5 bg-white border-top border-bottom overflow-hidden">
      <div class="container py-4">
        <div class="text-center mb-5" data-aos="fade-up">
          <span class="text-secondary-gold fw-bold tracking-widest text-uppercase d-block mb-2">الرحلة المتكاملة</span>
          <h2 class="fw-black text-primary-green display-5 mb-3">كيف تصنع كنف رحلة كفالة تنبض بالأثر؟</h2>
          <p class="text-muted fs-5 mx-auto" style="max-width: 600px;">عملية تواصل رقمية عالية الدقة تنقل مشاعر الدعم من
        ...
        <div class="row g-5 align-items-center mt-3">
          <div class="col-lg-6" data-aos="fade-right">
            <div class="timeline-item">
              ...
              <p class="text-muted">استعراض صور تفاعلية، وقصص حقيقية مدققة ومحدثة بشكل تام لنفوس تنبض بالأمل، لتختار من
                تبتغي أن تكون كنفه وظله.</p>
            </div>
            <div class="timeline-item">
              <div class="timeline-dot"></div>
              <h4 class="fw-bold text-primary-green mb-2">2. التزام الكفالة برضا مالي فوري</h4>
              <p class="text-muted">نظام تعبئة ميسر وبوابات كفالة تلقائية فورية تضمن الثبات المالي لليتيم شهراً تلو
                الآخر
            ...
            <div class="timeline-item">
              ...
              <p class="text-muted">استلام تقارير دورية دراسية وصحية شاملة موقعة من الوصي والأم المتابعة بشكل مباشر،
                لتشعر
              ...
              <div class="row g-4">
                ...
                <div class="col-lg-4">
                  <div class="testimonial-3d-card h-100">
                    ...
                    <p class="text-muted lh-lg mb-0">
                      منصة كنف تفوق التوقعات بروحيتها وشفافيتها. التقارير الدراسية التي تصلني بانتظام تجعلني أحضر فرحة
                      أحمد
                ...
                <div class="col-lg-4">
                  <div class="testimonial-3d-card h-100">
                    ...
                    <p class="text-muted lh-lg mb-0">
                      تسهيل عمليات الخصم التلقائي والبطاقات الائتمانية رفع عبئاً كبيراً عني وجعل متابعة الأطفال أكثر
                      سهولة
                      وراحة.
                    </p>
                  </div>
                ...
                <div class="col-lg-4">
                  <div class="testimonial-3d-card h-100">
                    ...
                    <p class="text-muted lh-lg mb-0">
                      تفاجأت بمستوى الحداثة البصرية والأداء الراقي للوحة التحكم وتجربة الكفالة السلسة والممتعة.
                    </p>
                  </div>
                </div>
              ...
              <div class="row g-4">
                ...
                <div class="col-lg-4">
                  <div class="testimonial-3d-card h-100">
                    ...
                    <p class="text-muted lh-lg mb-0">
                      التقارير الشهرية والصور المحدثة جعلتني أشعر أنني قريبة من الطفل الذي أكفله وأتابع نجاحاته
                      باستمرار.
                    </p>
                  </div>
                </div>
                ...
                <div class="col-lg-4">
                  <div class="testimonial-3d-card h-100">
                    ...
                    <p class="text-muted lh-lg mb-0">
                      من أكثر المنصات وضوحاً واحترافية في عرض أثر التبرعات وإيصال التقارير المالية والتنموية.
                    </p>
                  </div>
                </div>
                ...
                <div class="col-lg-4">
                  <div class="testimonial-3d-card h-100">
                    ...
                    <p class="text-muted lh-lg mb-0">
                      تجربة جميلة ومؤثرة جعلتني أحرص على زيادة مساهمتي السنوية ومشاركة المنصة مع عائلتي وأصدقائي.
                    </p>
                  </div>
                </div>
      ...
      <div class="container py-3">
        <div class="cta-container text-center text-white position-relative">
          ...
          <div class="position-relative" style="z-index: 5;" data-aos="zoom-in">
            <span class="badge bg-secondary-gold text-dark mb-3 px-3 py-2 fw-extrabold text-uppercase rounded-pill">نداء
            ...
            <p class="lead text-white-50 mb-5 mx-auto" style="max-width: 650px; font-size: 1.2rem; line-height: 1.9;">
              بمبلغ يسير جداً كل شهر، تضمن حماية ورعاية يتيم كنف. اجعل كفالتك صدقةً جارية تمنح طفلاً فرصة حياة كريمة،
    ...
    <div class="container py-4">
      <div class="row g-4">
        <div class="col-lg-4 col-md-6">
          <div class="footer-info">
            ...
            <div class="d-flex gap-2 mt-4 text-white">
              <a href="#" class="btn btn-sm btn-outline-secondary text-white"><i class="bi bi-twitter-x"></i></a>
              <a href="#" class="btn btn-sm btn-outline-secondary text-white"><i class="bi bi-facebook"></i></a>
              <a href="#" class="btn btn-sm btn-outline-secondary text-white"><i class="bi bi-instagram"></i></a>
              <a href="#" class="btn btn-sm btn-outline-secondary text-white"><i class="bi bi-linkedin"></i></a>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-2 col-md-6">
          ...
          <ul class="list-unstyled text-small text-white d-flex flex-column gap-2 mb-0">
            <li><a href="sponsor/dashboard.html" class="text-white text-decoration-none">بوابة الكافل المشترك</a></li>
            <li><a href="guardian/dashboard.html" class="text-white text-decoration-none">بوابة الأوصياء والأمهات</a>
            </li>
            <li><a href="admin/dashboard.html" class="text-white text-decoration-none">لوحة الإدارة الشاملة</a></li>
          </ul>
        </div>
        <div class="col-lg-4 col-md-6">
          <h6 class="text-white fw-bold mb-3">النشرة الإخبارية</h6>
          <p class="text-white text-small mb-3">اشترك معنا ليصلك تحديثات وتقارير أثر الكفالات وأحدث الأيتام المسجلين.
          </p>
